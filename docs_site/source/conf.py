import os
import sys
# This tells Sphinx to look two levels up to find the 'src' folder
sys.path.insert(0, os.path.abspath('../../'))

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#
# Thermal-Quantum-Numerov-Solver documentation build configuration file, created by
# sphinx-quickstart on Wed Feb 18 15:15:57 2026.
#
...
extensions = [
    'sphinx.ext.autodoc',     # Reads the code
    'sphinx.ext.todo',
    'sphinx.ext.napoleon',    # Translates Google-style docs
...
project = 'Thermal-Quantum-Numerov-Solver'
copyright = '2026, Pablo Sanchez, Juan Montoya'
author = 'Pablo Sanchez, Juan Montoya'
...
#
# html_title = 'Thermal-Quantum-Numerov-Solver v1.0'
...
latex_documents = [
    (master_doc, 'Thermal-Quantum-Numerov-Solver.tex', 'Thermal-Quantum-Numerov-Solver Documentation',
     'Pablo Sanchez, Juan Montoya', 'manual'),
]
...
man_pages = [
    (master_doc, 'thermal-quantum-numerov-solver', 'Thermal-Quantum-Numerov-Solver Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Thermal-Quantum-Numerov-Solver', 'Thermal-Quantum-Numerov-Solver Documentation',
     author, 'Thermal-Quantum-Numerov-Solver', 'One line description of project.',
     'Miscellaneous'),
]
